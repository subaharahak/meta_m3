    ...
    def process_all():
        ...
        for cc in cc_lines:
            try:
                ...
                if "Nice! New payment method added" in result or "Payment method successfully added." in result or "Insufficient Funds" in result or "Gateway Rejected: avs"in result or "Payment method added successfully" in result or "Card Issuer Declined CVV" in result or "Duplicate" in result or "You cannot add a new payment method so soon after the previous one. Please wait for 20 seconds" in result or "Invalid postal code or street address" or "Reason: CVV" in result:
                    approved += 1
