...
def get_rotating_user_agent():
    agents = [
        ...
        "Mozilla/5.0 (Linux; Android 13; SM-G996B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36",
    ]
...
💳𝗖𝗖 ⇾ {n}|{mm}|{yy}|{cvc}
🚀𝗥𝗲𝘀𝗽𝗼𝗻𝘀𝗲 ⇾ Product failed to add to cart
💰𝗚𝗮𝘁𝗲𝘄𝗮𝘆 ⇾ Shopify Checkout
...
💳𝗖𝗖 ⇾ {n}|{mm}|{yy}|{cvc}
🚀𝗥𝗲𝘀𝗽𝗼𝗻𝘀𝗲 ⇾ Cart Checkout Failed - Change Proxy & Retry
💰𝗚𝗮𝘁𝗲𝘄𝗮𝘆 ⇾ Shopify Checkout
...
💳𝗖𝗖 ⇾ {n}|{mm}|{yy}|{cvc}
🚀𝗥𝗲𝘀𝗽𝗼𝗻𝘀𝗲 ⇾ Payment Session Creation Failed - Use Proxy / Update Headers
💰𝗚𝗮𝘁𝗲𝘄𝗮𝘆 ⇾ Shopify Checkout
